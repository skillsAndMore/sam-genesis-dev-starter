 ...
 *
 * This file adds the required helper functions used in the SkillsAndMore Genesis Dev Starter Theme.
 *
 ...
 */
function sam_dev_customizer_get_default_link_color() {
 ...
 */
function sam_dev_customizer_get_default_accent_color() {
 ...
 */
function sam_dev_color_contrast( $color ) {
 ...
 */
function sam_dev_color_brightness( $color, $change ) {
