 ...
 *
 * This file adds the required CSS to the front end to the SkillsAndMore Genesis Dev Starter Theme.
 *
...
add_action( 'wp_enqueue_scripts', 'sam_dev_css' );
/**
...
function sam_dev_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'sam_dev_logo_width', 350 );
	...
	$css .= ( sam_dev_customizer_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$css .= ( sam_dev_customizer_get_default_accent_color() !== $color_accent ) ? sprintf(
		'
